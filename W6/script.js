...
document.addEventListener('DOMContentLoaded', function() {
    ...
    displayButton.addEventListener('click', function() {
        ...
        restaurants.forEach(function(restaurant) {
            ...
            div.innerHTML = `
                ...
                <p class="restaurant-cuisine">Cuisine: ${restaurant.cuisine}</p>
                <p class="restaurant-rating">Rating: ${restaurant.rating}</p>
                <p class="restaurant-price">Price: ${restaurant.priceRange}</p>
            `;
    ...
    mapButton.addEventListener('click', function() {
        ...
        mappedList.innerHTML = '<ul class="name-list">' + names.map(name => `<li>${name}</li>`).join('') + '</ul>';
    });
    ...
    errorButton.addEventListener('click', async function() {
        ...
        try {
            ...
            div.textContent = 'Oops! Something went wrong while loading data. Please try again later.';
